...
<script type="text/javascript"
	src="<%=application.getContextPath()%>/script/business/core-tasklog.js"></script>
<title>展现业务日志</title>
</head>
<body>
	<div id="toolsbar">
	...
	<table id="dd" class="easyui-datagrid"
		data-options="url:'task_list.action',method:'get',toolbar:'#pp',fit:true,border:false,rownumbers:true">
		<thead>
			<tr>
